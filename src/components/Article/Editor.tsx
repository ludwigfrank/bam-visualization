...
interface Props {
    handleDocumentLinkMutation: Function
}
...
export default class Article extends React.Component <Props, State> {
    ...
    setMarkRef = (e: HTMLElement, id: number) => {
        this.links = this.links.set(id, e)
    }

    renderMark = (props: RenderMarkProps): any => {
        const { children, attributes } = props
        const mark: any = props.mark
        const attrs = {...attributes, id: mark.data.get('documentID')}
        switch (mark.type) {
            case 'bold':
        ...
        return (
            <Wrapper>
                <Menu
                    ...
                    handleDocumentLinkMutation={this.props.handleDocumentLinkMutation}
                />
                <Editor
